...
síkidomról van szó, és számolja ki a kerületét (0 tetszőleges paraméter: négyzet, 1 tetszőleges paraméter:
téglalap, 2 tetszőleges paraméter: háromszög, 3 vagy több tetszőleges paraméter: sokszög)!
...
print(f"A kerület: {kerulet(5, 10, 12.5, 6)}")